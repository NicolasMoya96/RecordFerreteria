...
function actualizarCarrito() {
  ...
  // Si se encuentra el contenedor, se limpia y se reconstruye la lista de productos
  if (carritoDiv) {
  ...
  // Actualiza el total mostrado en el DOM, si existe el elemento
  if (totalSpan) {
...
// Exportamos las funciones para que puedan ser importadas en los tests
module.exports = {
  agregarAlCarrito,
  actualizarCarrito,
  eliminarDelCarrito,
  vaciarCarrito,
  toggleCarrito,
  // También exportamos las variables globales para poder verificarlas en las pruebas
  carrito,
  total
};
